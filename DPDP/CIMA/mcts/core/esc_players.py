...
from ICDM2026.DPDP.CIMA.mcts.core.helpers import DialogSession, EmotionSupportDialogSession
from ICDM2026.DPDP.CIMA.mcts.core.gen_models import GenerationModel, DialogModel
from ICDM2026.DPDP.CIMA.mcts.core.game import EmotionalSupportGame
from ICDM2026.DPDP.CIMA.mcts.utils.utils import safe_entropy
from abc import ABC, abstractmethod
from collections import Counter
from ICDM2026.DPDP.CIMA.ppdpp.utils import reward_dict
...
class ESCChatSystemPlanner(ESCSystemPlanner):
    ...
    def predict(self, state: DialogSession, policy, ent_bound, agent_state) -> "Tuple[np.ndarray, float]":
        ...
        # agent_entropy = safe_entropy(agent_dist)
        # if agent_entropy < ent_bound:
